...
const chat = () => {
  return (
    <div className="relative bg-white shadow-lg rounded-lg border-2 duration-300 hover:bg-slate-100 border-x-stone-200">
      <header className="pt-6 pb-4 px-5 border-b border-gray-200">
        <div className="flex justify-between items-center mb-3">
          <div className="flex items-center">
            ...
            <div className="pr-1">
              ...
              <a
                className="block text-sm font-medium hover:text-[#329c8f]"
                href="#0"
              >
                @lauren.mars
              </a>
        ...
        <div className="flex flex-wrap justify-center sm:justify-start space-x-4">
          ...
          <div className="flex items-center">
            ...
            <a
              className="text-sm font-medium whitespace-nowrap text-[#329c8f] hover:text-[#268277] ml-2"
              href="#0"
            >
              carolinmcneail.com
            </a>
      ...
      <button className="absolute bottom-5 right-5 inline-flex items-center text-sm font-medium text-white bg-[#329c8f] hover:bg-[#268277] rounded-full text-center px-3 py-2 shadow-lg focus:outline-none focus-visible:ring-2">
        <svg
          className="w-3 h-3 fill-current text-[#94d4cc] flex-shrink-0 mr-2"
          viewBox="0 0 12 12"
        >
