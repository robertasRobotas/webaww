...
const Points = () => {
  ...
  return (
    <div className="h-full bg-white shadow-lg rounded-lg p-5  hover:bg-slate-100 duration-300  border-2 border-x-stone-200 ">
      <ul className="space-y-4">
          ...
          <div className="flex items-start">
            ...
            <div>
              <h4 className="text-lg font-bold text-gray-900 mb-1">
                {t("reactPerformanceTitle")}
              </h4>
              <p className="text-sm text-gray-500 leading-relaxed">
                {t("reactPerformanceSubtitle")}
              </p>
            </div>
          </div>
        </li>
        <li>
          <div className="flex items-start">
            ...
            <div>
              <h4 className="text-lg font-bold text-gray-900 mb-1">
                {t("reactComponentsTitle")}
              </h4>
              <p className="text-sm text-gray-500 leading-relaxed">
                {t("reactComponentsSubtitle")}
              </p>
            </div>
          </div>
        </li>
